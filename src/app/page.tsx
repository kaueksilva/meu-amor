      ...
      {showContent ? (
        <div className="w-full max-w-6xl flex flex-col items-center space-y-6 z-10">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-2xl">
            ...
            Eu quero que saiba que sou um homem pequeno obviamente não preciso nem falar kkkkk, mas quando estou perto de você eu me sinto gigante e a pessoa mais forte do mundo por ter você ao meu lado, cada dia ao seu lado é um presente que eu guardo com todo cuidado no meu coração. Sua beleza, seu sorriso e seu amor iluminam minha vida de uma forma que palavras nunca poderão expressar completamente. Quero que você saiba que você é a pessoa mais especial do mundo para mim, e eu sou o homem mais feliz por ter você ao meu lado. Te amo mais do que todas as estrelas no céu e todas as gotas no oceano, não existe número e nem quantidade que consiga contar o amor que sinto por você. ❤️
            </p>
          </div>
        </div>
      ) : (
